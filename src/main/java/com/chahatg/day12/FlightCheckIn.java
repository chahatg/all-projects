...
/*1.) Create a connecting Flights checkin application which gives timestamp
 *for different timezones it connects ,like if a person checks for flights 
 *from New York to Tokyo, it should display the times in his zone and connected
 *and destination place zone too*/
